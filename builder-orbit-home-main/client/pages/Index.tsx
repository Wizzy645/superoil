  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      >
        ...
        <div className="service-cards-overlay absolute top-[518px] left-[3px] sm:top-[420px] sm:left-1/2 sm:transform sm:-translate-x-1/2 md:top-[460px] lg:top-[500px] xl:top-[580px] 2xl:top-[650px] w-full max-w-7xl px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-20">
