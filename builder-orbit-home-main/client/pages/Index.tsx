  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      >
        ...
        <div className="service-cards-overlay absolute top-[518px] left-[178px] sm:top-[420px] sm:left-1/2 sm:transform sm:-translate-x-1/2 md:top-[460px] lg:top-[500px] xl:top-[580px] 2xl:top-[650px] w-full max-w-7xl px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-20">
        ...
        <div
          className="hero-pagination absolute bottom-6 sm:bottom-8 md:bottom-10 lg:bottom-12 xl:bottom-16 2xl:bottom-20 left-1/2 transform -translate-x-1/2 flex items-center space-x-1.5 sm:space-x-2 md:space-x-2.5 lg:space-x-3 xl:space-x-4"
          style={{
