  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      >
        ...
        <div
          className="service-cards-overlay absolute top-[350px] sm:top-[420px] md:top-[460px] lg:top-[500px] xl:top-[580px] 2xl:top-[650px] left-1/2 transform -translate-x-1/2 w-full max-w-7xl px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16 2xl:px-20"
          style={{
